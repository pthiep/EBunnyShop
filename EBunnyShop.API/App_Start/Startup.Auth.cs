...
[assembly: OwinStartup(typeof(EBunnyShop.API.App_Start.Startup))]

namespace EBunnyShop.API.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(EBunnyShopDbContext.Create);
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<EBunnyShopDbContext>());
